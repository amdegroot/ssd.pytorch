...
class SSD(nn.Module):
    ...
    def load_weights(self, base_file):
        ...
        if ext == '.pkl' or '.pth':
            ...
            print('Sorry only .pth and .pkl files supported right now.')

#TODO initialize weights function using xavier method
...
def add_extras(cfg, i, batch_norm=False):
    ...
    #     if v == 'S':
    #         layers += [nn.Conv2d(cfg[i-1], cfg[i+1], kernel_size = (1,3)[k%2], stride=2, padding=1)]
    #         i+=1
    #     else:
    #         print(i%2)
    #         layers += [nn.Conv2d(in_channels, v, kernel_size = (1,3)[k%2], stride=s, padding=p)]
    #         in_channels = v
    #     i+=1
